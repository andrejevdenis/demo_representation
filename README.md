...
1. Open [![Jenkins project](https://github.com/andrejevdenis/demo_representation/blob/master/Icons/Jenkins.png)](https://jenkins.autotests.cloud/job/demo-representation/)
